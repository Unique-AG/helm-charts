...
```sh
helm install my-kong-plugins oci://ghcr.io/unique-ag/helm-charts/kong-plugins --version 2.6.1
```
...
helm install my-kong-plugins unique/kong-plugins --version 2.6.1
```
...
**Example** (enable the cluster-wide plugin after Redis is provisioned):
