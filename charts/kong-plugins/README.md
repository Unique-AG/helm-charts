...
```sh
helm install my-kong-plugins oci://ghcr.io/unique-ag/helm-charts/kong-plugins --version 2.7.2
```
...
helm install my-kong-plugins unique/kong-plugins --version 2.7.2
```
