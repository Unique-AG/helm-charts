...
helm install my-backend-service unique/backend-service --version 4.1.0

# or
helm install my-backend-service oci://ghcr.io/unique-ag/helm-charts/backend-service --version 4.1.0
```
