...
helm install my-backend-service unique/backend-service --version 10.1.2

# OCI
helm install my-backend-service oci://ghcr.io/unique-ag/helm-charts/backend-service --version 10.1.2
```
