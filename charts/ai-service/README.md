...
Version 2.1.2 is the last supported iteration of this chart. Subsequent changes will only be supplied to https://artifacthub.io/packages/helm/unique/backend-service. Refer to End of Life Notice in README.md.

> [!IMPORTANT]
> Version `2.1.2` is the last supported iteration of this chart. Subsequent changes will only be supplied to [`unique/backend-service`](https://artifacthub.io/packages/helm/unique/backend-service). Refer to [**End of Life Notice**](#End-of-Life-Notice).
...
helm install my-ai-service unique/ai-service --version 2.1.2

# or
helm install my-ai-service oci://ghcr.io/unique-ag/helm-charts/ai-service --version 2.1.2
```
...
⚠️ Version `2.1.2` represents the final supported release of this chart.
