...
![Version: 4.1.3](https://img.shields.io/badge/Version-4.1.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)
...
helm install my-web-app unique/web-app --version 4.1.3

# or
helm install my-web-app oci://ghcr.io/unique-ag/helm-charts/web-app --version 4.1.3
```
